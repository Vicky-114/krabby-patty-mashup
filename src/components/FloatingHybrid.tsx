...
const FloatingHybrid = ({ hybrid, index }: FloatingHybridProps) => {
  ...
  // Get the primary component character for the image
  ...
  return (
    <div
      className="fixed pointer-events-none transition-all duration-[3000ms] ease-in-out"
      style={{
        left: `${position.x}%`,
        top: `${position.y}%`,
        animationDelay,
    ...
    >
      <div className="float-animation opacity-60 hover:opacity-100 transition-opacity">
        <div className="relative group">
          {/* Hybrid character visualization - merge multiple character images */}
          ...
          {/* Hover tooltip */}
          <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-auto">
