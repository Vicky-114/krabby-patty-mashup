...
import HybridDetailDialog from './HybridDetailDialog';
      ...
      >
        <div className="float-animation opacity-70 hover:opacity-100 transition-opacity">
          ...
          >
            ...
            <div className="relative w-20 h-20 md:w-28 md:h-28 transition-transform hover:scale-110">
              {hasGeneratedImage ? (
            ...
            <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
              <div className="bg-card text-card-foreground p-3 rounded-lg shadow-deep min-w-[150px] border-2 border-primary text-center">
                <h3 className="font-bold text-primary text-sm">{hybrid.name}</h3>
